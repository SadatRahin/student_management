...
export class TeacherDashboardComponent implements OnInit {
  ...
  activeTab: 'dashboard'|'students'|'subjects'|'teachers'|'assign'|'stats'|'routine'|'attendance' = 'dashboard';
  ...
  loadTheme(): void { const s=localStorage.getItem('dashboardTheme'); this.theme=s==='light'?'light':'dark'; this.applyTheme(); }
