...
export class TeacherViewComponent implements OnInit {
  ...
  activeTab: 'dashboard'|'my-subjects'|'students'|'routine'|'attendance'|'profile' = 'dashboard';
  ...
  loadTheme(): void { const s=localStorage.getItem('teacherTheme'); this.theme=s==='light'?'light':'dark'; this.applyTheme(); }
